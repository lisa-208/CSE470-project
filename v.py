...
class V(tk.Tk):
    ...
    def _config_button_style(self):
        ...
        #number button style
        style.configure('N.TButton', background='purple', foreground='black')
        #operator button style
        style.configure('O.TButton', background="purple",foreground='black')
        #baki button
        style.configure('B.TButton', background ='purple',foreground='black')
